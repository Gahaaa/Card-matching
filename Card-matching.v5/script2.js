...
// function recordTxt(){
//   const clearCard = document.querySelector(`.result .record table tr .card_num`);
//   const clearHint = document.querySelector(`.result .record table tr .hint_num`);
//   const clearLife = document.querySelector(`.result .record table tr .life_num`);
//   const clearTime = document.querySelector(`.result .record table tr .time`);
